...
| Guide | Description |
|---|---|
| [01-setup.md](01-setup.md) | Install the Arduino IDE or Arduino CLI, ESP32 board package, and configure board settings |
...
| [vscode-setup.md](vscode-setup.md) | VS Code + Arduino CLI development setup |
...
1. [Set up the IDE and board package](01-setup.md) — Arduino IDE or Arduino CLI
